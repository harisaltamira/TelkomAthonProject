...
function Item({ item }) {
    return (
        <View style={styles.listItem}>
            ...
            <TouchableOpacity onPress={() => alert(JSON.stringify(item))} style={{ height: 50, width: 50, justifyContent: "center", alignItems: "center" }}>
...
export default class ExampleFlatlist extends React.Component {
    state = {
        data: [
            {
                "name": "Miyah Myles",
